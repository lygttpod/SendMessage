 ...
 * 选择照片
 */
public class SelectPhotosActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 200) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                ToastUtils.showGlobalLong("设置->隐私->开启权限");
            }
        }
    }
